...
var checkCaptcha = (captcha) => {
    return new Promise((res, rej) => {
        axios
            .post("https://www.google.com/recaptcha/api/siteverify", qs.stringify({
